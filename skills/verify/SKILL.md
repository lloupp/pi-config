...
compatibility: qualquer projeto com superfície executável.
---
...
| Mudança cross-ambiente | teste no ambiente-alvo. Se não puder testar em um deles, diga qual ficou sem verificação e por quê. |
